...
class Conversation(BaseModel):
    ...
    client = relationship("app.models.models.User", foreign_keys=[client_id], backref="client_conversations")
    band = relationship("app.models.models.User", foreign_keys=[band_id], backref="band_conversations")
    venue_owner = relationship("app.models.models.User", foreign_keys=[venue_owner_id], backref="venue_owner_conversations")
