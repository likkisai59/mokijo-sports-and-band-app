...
from app.api.band_auth.crud import create_account
from app.api.band_categories.crud import create_category
from app.api.band_artists import crud as artist_crud
