...
api_router.include_router(band_notifications_router)
api_router.include_router(band_payments_router)
api_router.include_router(band_messaging_router)
api_router.include_router(band_promos_router)
