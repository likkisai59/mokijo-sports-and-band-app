    ...
    return (
        <>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "24px" }}>
                <div>
                    <h1 className="vd-page-title" style={{ margin: 0 }}>Live Matches & Scoreboard</h1>
                    <p className="vd-page-sub" style={{ marginTop: "4px", marginBottom: 0 }}>Create, schedule, and score matches for teams in real time</p>
                </div>
                <Link href="/venue-dashboard/matches/create" className="m-create-btn" style={{ textDecoration: "none", backgroundColor: "#10b981", color: "#fff", boxShadow: "0 4px 14px rgba(16, 185, 129, 0.3)" }}>
                    <Plus size={16} />
                    New Match
                </Link>
            </div>
                        ...
                        return (
                            <div key={match.id} className={`m-card ${match.status}`}>
                                ...
                                <div className="m-card-actions">
                                    ...
                                    {match.status === "live" && (
                                        <>
                                            <Link href={`/venue-dashboard/matches/${match.id}/manage`} className="m-btn primary">
                                                <Activity size={14} />
                                                Scorekeep
                                            </Link>
