    ...
    if (!match) {
        return (
            <div className="vd-card" style={{ padding: 48, textAlign: "center" }}>
                ...
                <Link href="/dashboard/matches" className="m-btn secondary" style={{ display: "inline-flex", marginTop: "24px", width: "200px", textDecoration: "none" }}>
                    Back to Matches
                </Link>
            </div>
        );
        ...
        <div style={{ padding: "20px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                    <Link href="/dashboard/matches" style={{ color: "var(--vd-muted)", display: "flex", alignItems: "center" }}>
                        <ArrowLeft size={20} />
                    </Link>
                    <div>
                        <h1 className="vd-page-title" style={{ color: "#fff", fontSize: "28px", fontWeight: "800", margin: 0 }}>Scorekeeper Panel</h1>
                        <p className="vd-page-sub" style={{ color: "var(--vd-muted)" }}>Updating live feed for: <strong style={{ color: "#fff" }}>{match.title}</strong></p>
                    </div>
                </div>
                    ...
                    <div className="op-scoreboard-card">
                        ...
                        <div className="op-teams-grid">
                            ...
                            <div className="op-team-col">
                                ...
                                <div className="op-score-row" style={{ display: "flex", gap: "8px", marginTop: "16px" }}>
