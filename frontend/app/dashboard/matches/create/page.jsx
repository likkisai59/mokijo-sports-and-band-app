    ...
    return (
        <div style={{ padding: "20px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px" }}>
                ...
                <div>
                    <h1 className="vd-page-title" style={{ color: "#fff", fontSize: "28px", fontWeight: "800", margin: 0 }}>Create Match</h1>
                    <p className="vd-page-sub" style={{ color: "var(--vd-muted)" }}>Schedule and setup teams for a new match</p>
                </div>
            </div>
            ...
            <div className="m-form-container">
                <form onSubmit={handleSave}>
                    ...
                    <div style={{ display: "flex", gap: "12px", justifyContent: "flex-end", marginTop: "24px" }}>
                        <Link href="/dashboard/matches" className="m-btn secondary" style={{ flex: "0 0 auto", width: "120px", textDecoration: "none" }}>
                            Cancel
                        </Link>
