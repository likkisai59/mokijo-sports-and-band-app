...
import "@/app/styles/activities.css";
...
export default function ActivitiesPage() {
    ...
    return (
        <div className="activities-container">
            ...
            {loading ? (
                <div
                    style={{ textAlign: "center", padding: "40px", color: "var(--brand-secondary)", fontWeight: "600" }}
                >
                    Loading Games...
                </div>
            ) : activities.length > 0 ? (
                                ...
                                <div className="game-card-body">
                                    ...
                                    <div className="game-players-progress">
                                        <div className="progress-header">
                                            ...
                                            <span className="slots-left">
                                                {confirmedRSVPs.length} / {activity.max_players}{" "}
                                                {isFull ? "(Full)" : ""}
                                            </span>
                                        </div>
                                    ...
                                    <div className="game-card-actions">
                                        ...
                                        {isJoined ? (
                                            ...
                                            <button
                                                className="waitlist-btn"
                                                onClick={() => handleJoinGame(activity.id)}
                                            >
                                                Join Waitlist
                                            </button>
                                        ) : (
