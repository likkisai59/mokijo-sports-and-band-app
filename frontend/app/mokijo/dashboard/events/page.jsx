        ...
        <div className="events-container">
            <div className="events-header">
                <div>
                    ...
                    <p>
                        {isMember
                            ? "View match fixtures, squad training sessions, and RSVP status"
            ...
            {loading ? (
                <div
                    ...
                    style={{ textAlign: "center", padding: "40px", fontSize: "16px", color: "#64748b" }}
                >
                    Loading events...
                </div>
            ) : filtered.length > 0 ? (
                        ...
                        <div className="event-card" key={event.id}>
                            ...
                            <div className="event-card-body">
                                ...
                                <div className="event-card-settings">
                                    {event.is_public ? (
                                        <span className="setting-badge">🌐 Public</span>
                                    ) : (
                                        <span className="setting-badge">🔒 Private</span>
                                    )}
                                    {event.attendance_tracking && (
                                        <span className="setting-badge">📝 Attendance Active</span>
                                    )}
