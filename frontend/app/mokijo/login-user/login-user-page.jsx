    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Clear any existing member or admin session details
                localStorage.removeItem("isMember");
                localStorage.removeItem("memberRole");
                localStorage.removeItem("clubName");
                localStorage.removeItem("userPhone");

                // Set standard user session details
            ...
            <div className="w-full max-w-[500px] p-6 md:p-8 z-10">
                <div className="bg-[#0e0e19]/45 border border-white/5 rounded-[24px] p-8 md:p-10 flex flex-col gap-8 backdrop-blur-[10px] shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
                    <div className="flex flex-col gap-2">
                        ...
                        <h1 className="text-2xl font-extrabold tracking-tight text-white">User Sign In</h1>
                        <p className="text-sm text-white/50">
                            Welcome back — enter your credentials to access your user account
                        </p>
                    </div>
                    ...
                    <div className="text-sm text-white/50 text-center">
                        ...
                        <Link href="/register-user" className="font-semibold text-[#c6ff3d] hover:text-[#b5eb29] hover:underline transition-colors">
                            Create one free
                        </Link>
                    </div>
                </div>
