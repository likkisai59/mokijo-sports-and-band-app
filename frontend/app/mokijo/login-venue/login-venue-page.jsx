                ...
                <div className="flex flex-col items-center justify-center w-full">
                    ...
                    {showSuccess ? (
                        <div className="w-full max-w-[360px] mb-4">
                            <AuthSuccessBanner variant="light">You can now sign in to manage your venues.</AuthSuccessBanner>
                        </div>
                    ) : null}
