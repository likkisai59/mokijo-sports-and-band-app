...
export default function LocationManagementPage() {
  const [activeTab, setActiveTab] = React.useState("areas_list");
  ...
  const [deleteConfirmArea, setDeleteConfirmArea] = React.useState(null);
  ...
  const handleAddCountry = async () => {
    ...
    try {
      ...
      toast.error(err.response?.data?.error?.message || "Failed registering country.");
    }
  };
  ...
  const handleAddState = async () => {
    ...
    try {
      ...
      toast.error(err.response?.data?.error?.message || "Failed registering state.");
    }
  };
  ...
  const handleAddCity = async () => {
    ...
    try {
      ...
      toast.error(err.response?.data?.error?.message || "Failed registering city.");
    }
  };
  ...
  const onSubmitArea = async (data) => {
    try {
      ...
      toast.error(err.response?.data?.error?.message || "Failed to save area.");
    }
  };
