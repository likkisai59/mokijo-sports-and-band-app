...
export default function CategoryManagementPage() {
  ...
  const [statusConfirmCategory, setStatusConfirmCategory] = React.useState(null);
  const [deleteConfirmCategory, setDeleteConfirmCategory] = React.useState(null);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const errMsg = err.response?.data?.error?.message || "Failed to save category.";
      toast.error(errMsg);
    }
  };
