...
export default function AdminBandManagementPage() {
  ...
  const [detailArtist, setDetailArtist] = React.useState(null);
  const [verifyArtist, setVerifyArtist] = React.useState(null);
  const [statusConfirmArtist, setStatusConfirmArtist] = React.useState(null);

  // Verification Input Fields State
  const [verifyStatus, setVerifyStatus] = React.useState("approved");
              ...
              <div className="space-y-2">
                ...
                {detailArtist.gallery.length === 0 ? (
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {detailArtist.gallery.map((img, idx) => (
              ...
              <div className="space-y-2">
                ...
                {detailArtist.videos.length === 0 ? (
                  ...
                  <div className="space-y-1">
                    {detailArtist.videos.map((vid, idx) => (
                      <a
                        key={idx}
                        href={vid}
                        target="_blank"
