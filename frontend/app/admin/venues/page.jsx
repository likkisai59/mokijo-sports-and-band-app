...
export default function AdminVenueManagementPage() {
  ...
  const [detailVenue, setDetailVenue] = React.useState(null);
  const [verifyVenue, setVerifyVenue] = React.useState(null);
  const [statusConfirmVenue, setStatusConfirmVenue] = React.useState(null);
