...
export const metadata = {
  ...
  description:
    "Connect and book professional music bands, solo artists, and top live performers directly for your corporate gigs, weddings, and private events.",
  metadataBase: new URL("http://localhost:3000"),
  openGraph: {
    title: "BandConnect — Book Live Music Bands Directly",
    description:
      "The Airbnb for live entertainment. Discover top-rated local bands, check real-time availability, secure escrow payouts.",
    url: "/",
