    ...
    switch (role) {
      ...
      case "venue_owner":
        return [
          ...
          { name: "Analytics",    href: "/band/venue/analytics",     icon: BarChart2 },
          { name: "Calendar",     href: "/band/venue/calendar",      icon: Calendar },
          { name: "Reviews",      href: "/band/venue/reviews",       icon: MessageSquare },
          { name: "Inbox",        href: "/band/venue/messages",      icon: Inbox },
          { name: "Earnings",     href: "/band/venue/earnings",      icon: IndianRupee },
