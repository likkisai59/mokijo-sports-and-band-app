...
export function ArtistPricing({ pricing = {}, onSave }) {
  ...
  const [packages, setPackages] = React.useState(pricing.packages || []);
  const [offers, setOffers] = React.useState(pricing.special_offers || []);
