...
import { artistProfileUpdateSchema } from "@/utils/validation";
...
export function ArtistProfileEdit({ profile = {}, onSuccess }) {
  ...
  const {
    ...
    defaultValues: {
      ...
      band_type: profile.band_type || "Solo",
  ...
  const toggleEquipment = (key) => {
    setValue(`equipment.${key}`, !watchedEquipment[key]);
  };
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {Object.keys(watchedEquipment).map(key => {
            const isSelected = !!watchedEquipment[key];
