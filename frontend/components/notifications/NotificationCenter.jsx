...
export function NotificationCenter({
  ...
  return (
    ...
    >
      ...
      {!isTrayMode && total > (filters.limit || 10) && (
        <div className="flex items-center justify-between pt-4 border-t border-border/20 mt-4">
          <p className="text-xs text-text-secondary">
            ...
            {Math.min((filters.page || 1) * (filters.limit || 10), total)} of {total} notifications
          </p>
          <div className="flex gap-2">
            ...
            <button
              onClick={() =>
                setFilters({ page: Math.min(Math.ceil(total / (filters.limit || 10)), (filters.page || 1) + 1) })
              }
